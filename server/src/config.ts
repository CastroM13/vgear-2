...
export class Config {
    ...
    'jhipster.mail.from' = 'vgear@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'vgear API';
    'jhipster.swagger.description' = 'vgear API documentation';
    ...
    'eureka.instance.appname' = 'vgear';
    'eureka.instance.instanceId' = 'vgear:${random.value}';
